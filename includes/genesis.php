...
// add_action( 'widgets_init', 'twp_remove_genesis_widgets', 20 );
/**
 * Disable some or all of the default Genesis widgets.
 *
 * @since 2.0.0
 */
function twp_remove_genesis_widgets() {
...
// add_action( 'init', 'twp_remove_layout_meta_boxes' );
/**
 * Remove the Genesis 'Layout Settings' meta box for posts and/or pages.
 *
 * @since 2.0.0
 */
function twp_remove_layout_meta_boxes() {
